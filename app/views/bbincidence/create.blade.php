...
<div class="panel panel-info"> <!-- Health Facility Information -->
	...
	<div class="panel-body">
		<div class="form-group">
			...
			{{ Form::label('occurrence_date', 'Occurence Date', array('class' => 'required')) }}
			{{ Form::text('occurrence_date', Input::old('occurrence_date'), array('class' => 'form-control standard-datepicker col-sm-4')) }}

		<!--	{{ Form::label('occurrence_time', 'Occurence Time', array('class' => 'required')) }}
			{{ Form::text('occurrence_time', Input::old('occurrence_time'), array('class' => 'form-control standard-datetimepicker col-sm-4')) }} -->
...
<div class="panel panel-info"> <!-- Victim Details -->
	...
	<div class="panel-body">
				...
				<div class="form-group">
					...
					{{ Form::label('personnel_othername', 'Other Name', array('class' => 'required')) }}
				...
				<div class="form-group">
					...
					{{ Form::label('personnel_age', 'Age', array('class' => 'required')) }}
				...
				<div class="form-group">
					...
					{{ Form::label('nok_email', 'Next Of Kin Email', array('class' => 'col-sm-2')) }}
					{{ Form::email('nok_email', Input::old('nok_email'), array('class' => 'form-control col-sm-4')) }}
				</div>

				<div class="form-group">
					{{ Form::label('nok_name', 'Next Of Kin name', array('class' => 'col-sm-2')) }}
					{{ Form::text('nok_name', Input::old('nok_name'), array('class' => 'form-control col-sm-4')) }}

					{{ Form::label('nok_telephone', 'Next Of Kin Telephone', array('class' => 'col-sm-2')) }}
