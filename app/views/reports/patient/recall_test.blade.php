...
@section("content")
	<div>
		<ol class="breadcrumb">
          ...
          <li><a href="#">Test(s) to recall in Visit</a></li>
          <li class="active">Test Result Recalled</li>
	...
	<div class="panel panel-primary">
		<div class="panel-heading ">
            <div class="container-fluid">
	            <div class="row less-gutter">
		            <div class="col-md-11">
						<span class="glyphicon glyphicon-filter"></span>{{ trans('messages.recall-test') }}
		...
		<!-- if there are creation errors, they will show here -->
			...
			<div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
					{{ Form::open(array('route' => array('reports.recallResults', $test->id), 'method' => 'POST')) }}
