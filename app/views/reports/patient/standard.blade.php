...
@forelse($tests as $test)
	...
	<table  id="results_content_id" style="border-bottom: 1px solid #cecfd5; font-size:10px;
 font-family: 'Courier New',Courier;">
		<tr>
						...
						@else
							...
							<tr>
								...
								<td width="50%">
									...
									{{ $test->isCompleted()?$test->testedBy->name:'Pending'}}
								</td>
							...
							<tr>
								...
								<td width="50%"><b>Date Reviewed</b>:</td>
