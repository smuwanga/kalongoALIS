...
class TestDataSeeder extends DatabaseSeeder
{
    public function run()
    {
        ...
        $unhlsDistrict = District::create(["name" => "UNICEF"]);
        $unhlsFacility = UNHLSFacility::create([
            "name" => "UNHLS",
            "district_id" => $unhlsDistrict->id]);
        ...
        $usersData = [
            [
                ...
                "email" => "admin@kblis.org",
                "name" => "kBLIS Administrator",
                "facility_id" => $unhlsFacility->id,
            ...
            [
                ...
                "facility_id" => $unhlsFacility->id,
                "designation" => "Administrator", "image" => "/i/users/user-2.jpg"],
            [
                "username" => "lmorena",
                "password" => Hash::make("password"),
                "email" => "lmorena@kblis.org",
                "name" => "L. Morena",
                "facility_id" => $unhlsFacility->id,
                "designation" => "Lab Technologist", "image" => "/i/users/user-3.png"],
            [
                "username" => "abumeyang",
                "password" => Hash::make("password"),
                "email" => "abumeyang@kblis.org",
                "name" => "A. Abumeyang",
                "facility_id" => $unhlsFacility->id,
                "designation" => "Doctor"],
        ];
